...
- **대사 장면**: 짧고 끊긴다. 인물별로 길이 차이가 큼 (시샤·하셈
...
- **색·아우라 어휘 (하셈 시각 결)**: 색의 결·번짐·잔향·어긋남·흐려짐
...
- **action beat 자주 활용**: 대사 사이에 행동이 들어가 인물의
  감정·자세를 보여준다.
- **인물별 차별화**:
  - **하셈**: 두세 음절 명사문. 짧다. 잊힌 신과의 대화에서만 길어짐.
    "표식이 없다." / "왜?" / "...들립니다."
...
> 미끄러졌다. 하셈은 자기 손바닥을 펴 보았다. 천 안쪽이었다.
...
> 하셈이 자기 손바닥의 검은 자국 주위 이름 없는 색의 잔향을 한 번
...
컷. 한 단어 "도용" 이 평생의 결의 어긋남을 한 번에 흡수한다. 하셈의
...
- **추상 보편화**: "우리는 모두 누군가의 이름을 잊고 산다" → 항상
  구체적으로. "하셈은 노파의 이름을 처음부터 모르고 있었다."
...
하셈 시점에서 사람의 아우라 색을 묘사할 일이 회차마다 1-3회.
...
- **색 묘사 자체가 사색이 아니다**: 하셈이 보는 색은 행동·환경의
...
- **속삭임 비용 발동 단락**: 색이 흐려져 보이는 24시간 동안 하셈의
